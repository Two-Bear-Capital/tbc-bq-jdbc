...
class ConnectionUrlParserTest {
  ...
  void testParseUrlWithUserOAuthAuth() throws SQLException {
    ...
    String url =
        "jdbc:bigquery:my-project?authType=USER_OAUTH&clientId=abc&clientSecret=def&refreshToken=xyz";
  ...
  void testParseUrlWithMultipleParameters() throws SQLException {
    ...
    String url =
        "jdbc:bigquery:my-project/my_dataset?authType=ADC&timeout=60&maxResults=5000&useLegacySql=false&location=US";
