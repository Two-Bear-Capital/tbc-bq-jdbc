  ...
  void testFullProperties() {
    ...
    ConnectionProperties props =
        new ConnectionProperties(
            ...
            "my_dataset",
            "dataset-project",
            new ServiceAccountAuth("/path/to/key.json"),
            120,
            1000L,
            true,
            "EU",
            labels,
            JobCreationMode.OPTIONAL,
            5000,
            "true",
            true,
            60,
  ...
  void testGetDatasetIdWithDifferentProject() {
    ...
    ConnectionProperties props =
        new ConnectionProperties(
            "my-project",
            "my_dataset",
            "other-project", // datasetProjectId
            new ApplicationDefaultAuth(),
            null,
            null,
            false,
