...
class ConnectionUrlParserSimbaTest {
  ...
  void testParseSimbaUrlWithUserOAuth() throws SQLException {
    ...
    String url =
        "jdbc:bigquery://https://www.googleapis.com/bigquery/v2:443;ProjectId=my-project;OAuthType=1;OAuthClientId=abc;OAuthClientSecret=def;OAuthRefreshToken=xyz";
  ...
  void testParseSimbaUrlWithExternalAccountRequiresCredentialFile() {
    ...
    String url =
        "jdbc:bigquery://https://www.googleapis.com/bigquery/v2:443;ProjectId=my-project;OAuthType=4";

    // Then: Should throw SQLException because WORKLOAD requires credentialConfigFile
  ...
  void testParseSimbaUrlWithExternalAccountAndCredentialFile() throws SQLException {
    // Given: A Simba URL with external account (OAuthType=4) and credential file via Properties
    String url =
        "jdbc:bigquery://https://www.googleapis.com/bigquery/v2:443;ProjectId=my-project;OAuthType=4";
  ...
  void testParseSimbaUrlWithAllProperties() throws SQLException {
    ...
    String url =
        "jdbc:bigquery://https://www.googleapis.com/bigquery/v2:443;ProjectId=my-project;DefaultDataset=my_dataset;OAuthType=3;Timeout=120;MaxResults=5000;UseLegacySQL=true;Location=EU;DatasetProjectId=other-project";
  ...
  void testParseSimbaUrlWithPropertiesObject() throws SQLException {
    ...
    String url =
        "jdbc:bigquery://https://www.googleapis.com/bigquery/v2:443;ProjectId=my-project;OAuthType=3;Timeout=60";
    Properties info = new Properties();
  ...
  void testParseSimbaUrlInvalidOAuthType() {
    ...
    String url =
        "jdbc:bigquery://https://www.googleapis.com/bigquery/v2:443;ProjectId=my-project;OAuthType=99";
  ...
  void testParseSimbaUrlUnsupportedOAuthType2() {
    ...
    String url =
        "jdbc:bigquery://https://www.googleapis.com/bigquery/v2:443;ProjectId=my-project;OAuthType=2";
  ...
  void testParseSimbaUrlMissingUserOAuthParameters() {
    ...
    String url =
        "jdbc:bigquery://https://www.googleapis.com/bigquery/v2:443;ProjectId=my-project;OAuthType=1;OAuthClientId=abc";

    // Then: Should throw SQLException
    SQLException ex = assertThrows(SQLException.class, () -> ConnectionUrlParser.parse(url, null));
    assertTrue(
        ex.getMessage().contains("clientSecret") || ex.getMessage().contains("refreshToken"));
  }
  ...
  void testParseSimbaUrlUnknownPropertiesIgnored() throws SQLException {
    ...
    String url =
        "jdbc:bigquery://https://www.googleapis.com/bigquery/v2:443;ProjectId=my-project;OAuthType=3;UnknownProperty=value;AnotherUnknown=test";
  ...
  void testParseSimbaUrlPropertyMapping() throws SQLException {
    ...
    String url =
        "jdbc:bigquery://https://www.googleapis.com/bigquery/v2:443;ProjectId=test-project;DefaultDataset=test_dataset;Timeout=90;MaxResults=2000;Location=asia-northeast1;DatasetProjectId=cross-project;OAuthType=3";
  ...
  void testSimbaUrlWithSpecialCharactersInPath() throws SQLException {
    ...
    String url =
        "jdbc:bigquery://https://www.googleapis.com/bigquery/v2:443;ProjectId=my-project;OAuthType=0;OAuthPvtKeyPath=/path/to/my key file.json";
  ...
  void testSimbaUrlBooleanPropertyParsing() throws SQLException {
    ...
    String url1 =
        "jdbc:bigquery://https://www.googleapis.com/bigquery/v2:443;ProjectId=my-project;OAuthType=3;UseLegacySQL=true";
    String url2 =
        "jdbc:bigquery://https://www.googleapis.com/bigquery/v2:443;ProjectId=my-project;OAuthType=3;UseLegacySQL=false";
