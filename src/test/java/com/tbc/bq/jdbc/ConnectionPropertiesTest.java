...
import com.tbc.bq.jdbc.auth.AuthType;
import com.tbc.bq.jdbc.auth.ServiceAccountAuth;
import com.tbc.bq.jdbc.config.ConnectionProperties;
import com.tbc.bq.jdbc.config.JobCreationMode;
...
class ConnectionPropertiesTest {
	...
	void testFullProperties() {
		...
		ConnectionProperties props = new ConnectionProperties("my-project", "my_dataset", "dataset-project",
				...
				JobCreationMode.OPTIONAL, 5000, "true", true, 60, 5, 1000000L, null, null, null, null);
