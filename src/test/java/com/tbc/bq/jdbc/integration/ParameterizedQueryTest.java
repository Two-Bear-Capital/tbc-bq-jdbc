...
class ParameterizedQueryTest extends AbstractBigQueryIntegrationTest {
	...
	@Test
	@org.junit.jupiter.api.Disabled("Confirmed emulator bug: NULL parameters with explicit types still return '0' instead of null")
	...
	@Test
	@org.junit.jupiter.api.Disabled("Confirmed emulator bug: setObject with explicit types still causes 'strconv.ParseInt: parsing \"test\": invalid syntax'")
