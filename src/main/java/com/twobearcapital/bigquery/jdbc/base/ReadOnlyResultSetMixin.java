...
/**
 * Mixin interface providing default implementations for all ResultSet update methods.
 * Consolidates ~140 lines of identical exception-throwing stubs per ResultSet implementation.
 *
 * <p>All update methods throw SQLFeatureNotSupportedException since BigQuery ResultSets
 * are read-only.
 */
