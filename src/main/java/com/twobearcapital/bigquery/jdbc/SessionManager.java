...
public class SessionManager {
  ...
  public void initializeSession() throws SQLException {
    ...
    try {
      ...
      QueryJobConfiguration queryConfig =
          QueryJobConfiguration.newBuilder(createSessionSql)
   ...
   *
   * @param configBuilder the query config builder
   * @return the builder with session property added
   */
  public QueryJobConfiguration.Builder addSessionProperty(
   ...
   * Closes the session.
   *
   * <p>Note: BigQuery sessions are automatically cleaned up after timeout. This method just marks
   * the session as closed locally.
   */
  public void close() {
    lock.lock();
    try {
  ...
  private void executeSessionStatement(String sql) throws SQLException {
    try {
      QueryJobConfiguration.Builder configBuilder =
          QueryJobConfiguration.newBuilder(sql).setUseLegacySql(false);
