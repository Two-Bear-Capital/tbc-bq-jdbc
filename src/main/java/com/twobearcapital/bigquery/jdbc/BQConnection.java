...
public final class BQConnection implements Connection {
   ...
   *
   * @param statement the statement to unregister
   */
  ...
  public void setTransactionIsolation(int level) throws SQLException {
    ...
    if (level != Connection.TRANSACTION_NONE) {
      throw new BQSQLFeatureNotSupportedException(
          "BigQuery does not support transaction isolation levels");
    }
  }
  ...
  public void setHoldability(int holdability) throws SQLException {
    ...
    if (holdability != ResultSet.CLOSE_CURSORS_AT_COMMIT) {
      throw new BQSQLFeatureNotSupportedException(
          "Only CLOSE_CURSORS_AT_COMMIT holdability is supported");
    }
  }
  ...
  public void setSchema(String schema) throws SQLException {
    checkClosed();
    // BigQuery uses dataset as schema, but we don't allow changing it after connection
