...
1. **Download Driver JAR**
   ```bash
   wget https://repo1.maven.org/maven2/vc/tbc/tbc-bq-jdbc/1.0.42/tbc-bq-jdbc-1.0.42.jar
   ```
...
After building:
- **Slim JAR:** `target/tbc-bq-jdbc-1.0.42.jar` (60K)
- **Shaded JAR:** `target/tbc-bq-jdbc-1.0.42.jar` (51M)
