...
1. **Download Driver JAR**
   ```bash
   wget https://repo1.maven.org/maven2/com/twobearcapital/tbc-bq-jdbc/1.0.9/tbc-bq-jdbc-1.0.9.jar
   ```
...
After building:
- **Slim JAR:** `target/tbc-bq-jdbc-1.0.9.jar` (60K)
- **Shaded JAR:** `target/tbc-bq-jdbc-1.0.9.jar` (51M)
