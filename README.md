...
1. **Download Driver JAR**
   ```bash
   wget https://repo1.maven.org/maven2/vc/tbc/tbc-bq-jdbc/1.0.44/tbc-bq-jdbc-1.0.44.jar
   ```
...
After building:
- **Slim JAR:** `target/tbc-bq-jdbc-1.0.44.jar` (60K)
- **Shaded JAR:** `target/tbc-bq-jdbc-1.0.44.jar` (51M)
