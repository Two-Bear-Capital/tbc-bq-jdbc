...
After building:
- **Slim JAR:** `target/tbc-bq-jdbc-1.0.100.jar` (60K)
- **Shaded JAR:** `target/tbc-bq-jdbc-1.0.100-shaded.jar` (51M)
- **Sources JAR:** `target/tbc-bq-jdbc-1.0.100-sources.jar` (41K)
- **Javadoc JAR:** `target/tbc-bq-jdbc-1.0.100-javadoc.jar` (267K)
