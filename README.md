...
After building:
- **Slim JAR:** `target/tbc-bq-jdbc-1.0.118.jar` (60K)
- **Shaded JAR:** `target/tbc-bq-jdbc-1.0.118-shaded.jar` (51M)
- **Sources JAR:** `target/tbc-bq-jdbc-1.0.118-sources.jar` (41K)
- **Javadoc JAR:** `target/tbc-bq-jdbc-1.0.118-javadoc.jar` (267K)
