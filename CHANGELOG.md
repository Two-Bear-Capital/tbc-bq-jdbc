...
- **auth:** Support service account impersonation ([#240](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/240)) [**BREAKING**]
- **metadata:** Make INFORMATION_SCHEMA browsable ([#246](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/246)) [**BREAKING**]
- **execution:** Reach every statement of a multi-statement script ([#249](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/249)) [**BREAKING**]
- **metadata:** Discover and switch between projects ([#250](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/250)) [**BREAKING**]
- **metadata:** Distinguish external tables, snapshots and clones ([#251](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/251)) [**BREAKING**]
- **metadata:** Report STRUCT subfields in getColumns() ([#253](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/253))

### 🐛 Bug Fixes

- **errors:** Report the service's own explanation, not the client's summary ([#244](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/244))
- **errors:** Report a rejected credential as SQLState 28000 ([#254](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/254))
- **storage:** Authenticate the Storage path with the connection's credential ([#255](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/255))

### 🔀 Pull Requests

- Merge pull request #256 from Two-Bear-Capital/release/4.0.0
...
- **metadata:** Return empty result sets from getAttributes and getClientInfoProperties ([#213](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/213))
- **execution:** Report the fetch size a ResultSet was read at ([#215](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/215))
- **metadata:** Implement getFunctions and getFunctionColumns ([#216](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/216))
- **metadata:** Implement getPseudoColumns for partition pseudo columns ([#217](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/217))
- **metadata:** Surface source SQL for views and routines in REMARKS ([#219](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/219))

### 🐛 Bug Fixes

- **metadata:** Restore the interrupt flag on a cancelled dataset read ([#212](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/212))
- **types:** Refuse a populated type map instead of ignoring it ([#218](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/218))

### 🔀 Pull Requests

- Merge pull request #221 from Two-Bear-Capital/release/3.1.0

Release 3.1.0: additive metadata and execution fixes

### 🧪 Testing

- **execution:** Prove cross-region jobs run and cancel ([#214](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/214))

### 👷 CI/CD

- **build:** Gate PRs into release/** integration branches

## [3.0.9] - 2026-07-29

### 📚 Documentation

- Trim CLAUDE.md to what a session cannot derive ([#211](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/211))

## [3.0.8] - 2026-07-29

### 📚 Documentation

- Capture the working knowledge 3.1.0 will need ([#209](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/209))

## [3.0.7] - 2026-07-29

### 🔨 Refactoring

- **test:** Share the single-column ResultSet fixture ([#208](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/208))

## [3.0.6] - 2026-07-28

### 🔨 Refactoring

- **base:** Delete the orphaned ReadOnlyResultSetMixin and cover the real base ([#207](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/207))

## [3.0.5] - 2026-07-28

### 🔨 Refactoring

- **metadata:** Extract the shared per-dataset INFORMATION_SCHEMA read ([#205](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/205))
...
- **contributing:** Name the integration project where the command lives ([#202](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/202))

## [3.0.2] - 2026-07-28

### 🔨 Refactoring

- **metadata:** Import BigQuery types instead of writing them out inline ([#201](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/201))

## [3.0.1] - 2026-07-28

### 📚 Documentation

- **jetbrains:** Point the open introspection gaps at their tracking issues ([#200](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/200))

## [3.0.0] - 2026-07-28

### ⚡ Features

- **config:** Apply or remove the advertised-but-inert properties (3.0.0) ([#181](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/181)) [**BREAKING**]

## [2.4.3] - 2026-07-28

### 🐛 Bug Fixes

- **config:** Apply maxBillingBytes to submitted jobs ([#180](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/180))

## [2.4.2] - 2026-07-28

### 📚 Documentation

- Deep accuracy, completeness and tone review of the user-facing docs ([#179](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/179))

## [2.4.1] - 2026-07-28

### 🚀 Performance

- **results:** Raise the default page size from 10,000 to 50,000 ([#168](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/168))
...
- **infra:** Grant CI the Storage Read API permission ([#166](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/166))

## [2.2.1] - 2026-07-28

### 🐛 Bug Fixes

- **metadata:** Validate identifiers before interpolating them into queries ([#161](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/161)) ([#162](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/162))

## [2.2.0] - 2026-07-28

### ⚡ Features

- **metadata:** Expose BigQuery's unenforced PK/FK constraints ([#84](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/84)) ([#160](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/160))

## [2.1.3] - 2026-07-28

### 🐛 Bug Fixes

- **test:** Make the timestamp assertion timezone-independent, and run CI in a non-UTC zone ([#158](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/158))

## [2.1.2] - 2026-07-28

### 🚀 Performance

- **metadata:** Fix three findings the new instrumentation surfaced ([#156](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/156))

## [2.1.1] - 2026-07-27

### 📚 Documentation

- **performance:** Correct the metadata plateau explanation and record first findings ([#154](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/154))

## [2.1.0] - 2026-07-27

### ⚡ Features

- **perf:** Instrument the driver for performance at scale and under load ([#153](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/153))

## [2.0.2] - 2026-07-27

### 📚 Documentation

- Remove stale README sections and dead Discussions links ([#151](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/151))

## [2.0.1] - 2026-07-27

### 🐛 Bug Fixes

- **ci:** Compute release-note JAR sizes from the built artifacts ([#150](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/150))

## [2.0.0] - 2026-07-27

### ⚡ Features

- **auth:** Remove emulator support and fail fast on a missing session ID ([#149](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/149)) [**BREAKING**]

## [1.1.2] - 2026-07-27

### 🐛 Bug Fixes

- **logging:** Quiet CI to WARN, and stop logging per-connection at INFO ([#146](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/146))

## [1.1.1] - 2026-07-27

### 🐛 Bug Fixes

- **test:** Derive version assertions from the version string, not literals ([#147](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/147))

## [1.1.0] - 2026-07-27

### ⚡ Features

- **auth:** Deprecate EmulatorAuth for removal ([#145](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/145))

## [1.0.129] - 2026-07-27

### ⚙️ Miscellaneous Tasks

- Remove the last emulator leftovers ([#143](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/143))
...
- **cost:** Estimate DML and collapsed batches, not just SELECTs ([#141](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/141))

## [1.0.125] - 2026-07-27

### 🐛 Bug Fixes

- **ci:** Replay the bump commit when main moves during a release ([#139](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/139))

## [1.0.124] - 2026-07-27

### 🧪 Testing

- **real:** Trim BasicConnectionTest to an emulator-support smoke test ([#138](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/138))

## [1.0.123] - 2026-07-27

### 🧪 Testing

- **real:** Port TransactionTest, and delete the emulator copy ([#137](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/137))

## [1.0.122] - 2026-07-27

### 🧪 Testing

- **real:** Retire five reconciled emulator classes ([#136](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/136))

## [1.0.121] - 2026-07-27

### 🧪 Testing

- **real:** Port StatementConfigurationTest, and delete the emulator copy ([#135](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/135))
...
- **real:** Port BatchExecutionTest and QueryCostEstimationTest, and delete the emulator copies ([#133](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/133))

## [1.0.118] - 2026-07-27

### 🧪 Testing

- **real:** Port the ComplexTypesTest default-mode group, and delete the emulator copy ([#132](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/132))

## [1.0.117] - 2026-07-27

### 🐛 Bug Fixes

- **resultset:** Report conversion failures as SQLException, and coerce getBoolean per the JDBC conversion table ([#131](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/131))

## [1.0.116] - 2026-07-27

### 🧪 Testing

- **real:** Port ResultSetAdvancedTest to real BigQuery, and delete the emulator copy ([#130](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/130))

## [1.0.115] - 2026-07-27

### 🧪 Testing

- **real:** Port SessionTest to real BigQuery, and delete the emulator copy ([#128](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/128))

## [1.0.114] - 2026-07-27

### 🐛 Bug Fixes

- **ci:** Derive the release version from Conventional Commits ([#126](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/126))
- **params:** Bind TIMESTAMP/TIME in the formats BigQuery accepts, and apply Calendar zones in the right direction ([#125](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/125))
...
- **test:** Guardrails for the real BigQuery tier before migrating tests to it ([#120](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/120))

## [1.0.111] - 2026-07-27

### 🐛 Bug Fixes

- **storage:** Stop useStorageApi routing results into an unimplemented ResultSet ([#117](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/117))

## [1.0.110] - 2026-07-27

### 🐛 Bug Fixes

- **ci:** Run Maven through the wrapper so the cache path exists ([#114](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/114))
...
- **statement:** Address AI code quality findings in query execution ([#103](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/103))

## [1.0.105] - 2026-07-27

### 🚀 Performance

- **ci:** Stop the docs check paying for a second cold Maven build ([#101](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/101))

## [1.0.104] - 2026-07-27

### 📚 Documentation

- Re-apply on current main (automatic version bump rewrote these lines) ([#91](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/91))
- Re-apply on current main (automatic version bump rewrote these lines) ([#90](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/90))
...
- **connection:** Lazy session start for setAutoCommit(false) + accurate transaction metadata ([#87](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/87))
...
- **release:** Don't commit git-cliff artifacts into the bump commit
...
- **types:** Correctly type primitives inside STRUCT and ARRAY ([#39](https://github.com/Two-Bear-Capital/tbc-bq-jdbc/issues/39))

### ⚙️ Miscellaneous Tasks

- Update CHANGELOG.md for version 1.0.79

## [1.0.78] - 2026-03-19

### 🔀 Pull Requests

- Merge pull request #40 from Two-Bear-Capital/dependabot/maven/maven-dependencies-2506a0f218

### ⚙️ Miscellaneous Tasks

- Update CHANGELOG.md for version 1.0.78

## [1.0.77] - 2026-03-16

### 🔀 Pull Requests

- Merge pull request #38 from Two-Bear-Capital/dependabot/maven/maven-dependencies-530c52a26f

### ⚙️ Miscellaneous Tasks

- Update CHANGELOG.md for version 1.0.77

## [1.0.76] - 2026-03-12

### 🔀 Pull Requests

- Merge pull request #36 from Two-Bear-Capital/dependabot/maven/maven-dependencies-7ed2feabfd
...
- Improve code readability and consistency with Locale, PMD ruleset, and suppressed warnings

### ⚙️ Miscellaneous Tasks

- Update CHANGELOG.md for version 1.0.75

## [1.0.74] - 2026-03-05

### 🔀 Pull Requests

- Merge pull request #35 from Two-Bear-Capital/dependabot/maven/maven-dependencies-f0ac80ae3e
...
- **pmd:** Update configuration to disable linkXRef and change output format
- Update CHANGELOG.md for version 1.0.73
...
- Update CHANGELOG.md for version 1.0.72
...
- **auth, storage:** Handle resource cleanup and error propagation

### ⚙️ Miscellaneous Tasks

- Update CHANGELOG.md for version 1.0.67

## [1.0.66] - 2026-03-04

### 🐛 Bug Fixes

- **statement:** Ensure query job future is canceled on timeout
...
- Update CHANGELOG.md for version 1.0.55
...
- Update CHANGELOG.md for version 1.0.54
...
[3.0.7]: https://github.com/Two-Bear-Capital/tbc-bq-jdbc/compare/v3.0.6...v3.0.7
[3.0.6]: https://github.com/Two-Bear-Capital/tbc-bq-jdbc/compare/v3.0.5...v3.0.6
[3.0.5]: https://github.com/Two-Bear-Capital/tbc-bq-jdbc/compare/v3.0.4...v3.0.5
...
[3.0.0]: https://github.com/Two-Bear-Capital/tbc-bq-jdbc/compare/v2.4.3...v3.0.0
[2.4.3]: https://github.com/Two-Bear-Capital/tbc-bq-jdbc/compare/v2.4.2...v2.4.3
[2.4.2]: https://github.com/Two-Bear-Capital/tbc-bq-jdbc/compare/v2.4.1...v2.4.2
[2.4.1]: https://github.com/Two-Bear-Capital/tbc-bq-jdbc/compare/v2.4.0...v2.4.1
...
[2.1.3]: https://github.com/Two-Bear-Capital/tbc-bq-jdbc/compare/v2.1.2...v2.1.3
[2.1.2]: https://github.com/Two-Bear-Capital/tbc-bq-jdbc/compare/v2.1.1...v2.1.2
[2.1.1]: https://github.com/Two-Bear-Capital/tbc-bq-jdbc/compare/v2.1.0...v2.1.1
[2.1.0]: https://github.com/Two-Bear-Capital/tbc-bq-jdbc/compare/v2.0.2...v2.1.0
[2.0.2]: https://github.com/Two-Bear-Capital/tbc-bq-jdbc/compare/v2.0.1...v2.0.2
[2.0.1]: https://github.com/Two-Bear-Capital/tbc-bq-jdbc/compare/v2.0.0...v2.0.1
[2.0.0]: https://github.com/Two-Bear-Capital/tbc-bq-jdbc/compare/v1.1.2...v2.0.0
[1.1.2]: https://github.com/Two-Bear-Capital/tbc-bq-jdbc/compare/v1.1.1...v1.1.2
[1.1.1]: https://github.com/Two-Bear-Capital/tbc-bq-jdbc/compare/v1.1.0...v1.1.1
[1.1.0]: https://github.com/Two-Bear-Capital/tbc-bq-jdbc/compare/v1.0.129...v1.1.0
[1.0.129]: https://github.com/Two-Bear-Capital/tbc-bq-jdbc/compare/v1.0.128...v1.0.129
...
[1.0.123]: https://github.com/Two-Bear-Capital/tbc-bq-jdbc/compare/v1.0.122...v1.0.123
[1.0.122]: https://github.com/Two-Bear-Capital/tbc-bq-jdbc/compare/v1.0.121...v1.0.122
[1.0.121]: https://github.com/Two-Bear-Capital/tbc-bq-jdbc/compare/v1.0.120...v1.0.121
...
[1.0.116]: https://github.com/Two-Bear-Capital/tbc-bq-jdbc/compare/v1.0.115...v1.0.116
[1.0.115]: https://github.com/Two-Bear-Capital/tbc-bq-jdbc/compare/v1.0.114...v1.0.115
[1.0.114]: https://github.com/Two-Bear-Capital/tbc-bq-jdbc/compare/v1.0.113...v1.0.114
...
[1.0.77]: https://github.com/Two-Bear-Capital/tbc-bq-jdbc/compare/v1.0.76...v1.0.77
[1.0.76]: https://github.com/Two-Bear-Capital/tbc-bq-jdbc/compare/v1.0.75...v1.0.76
[1.0.75]: https://github.com/Two-Bear-Capital/tbc-bq-jdbc/compare/v1.0.74...v1.0.75
[1.0.74]: https://github.com/Two-Bear-Capital/tbc-bq-jdbc/compare/v1.0.73...v1.0.74
[1.0.73]: https://github.com/Two-Bear-Capital/tbc-bq-jdbc/compare/v1.0.72...v1.0.73
