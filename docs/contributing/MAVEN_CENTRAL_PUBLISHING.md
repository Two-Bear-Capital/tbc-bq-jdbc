...
|----------|-----------|------|-------------|
| `tbc-bq-jdbc-1.0.108.jar` | *(none)* | ~60KB | Slim JAR (requires dependencies) |
| `tbc-bq-jdbc-1.0.108-shaded.jar` | `shaded` | ~38MB | Fat JAR with all dependencies |
| `tbc-bq-jdbc-1.0.108-with-logging.jar` | `with-logging` | ~39MB | Fat JAR + Logback (for IntelliJ) |
| `tbc-bq-jdbc-1.0.108-sources.jar` | `sources` | ~200KB | Source code |
| `tbc-bq-jdbc-1.0.108-javadoc.jar` | `javadoc` | ~500KB | Javadoc |
...
dependencies {
    ...
    // Or shaded variant
    implementation 'vc.tbc:tbc-bq-jdbc:1.0.108:shaded'
}
```
...
wget https://repo1.maven.org/maven2/vc/tbc/tbc-bq-jdbc/1.0.108/tbc-bq-jdbc-1.0.108.jar
```
