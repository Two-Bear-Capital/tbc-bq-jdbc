...
|----------|-----------|------|-------------|
| `tbc-bq-jdbc-3.0.7.jar` | *(none)* | ~60KB | Slim JAR (requires dependencies) |
| `tbc-bq-jdbc-3.0.7-shaded.jar` | `shaded` | ~38MB | Fat JAR with all dependencies |
| `tbc-bq-jdbc-3.0.7-with-logging.jar` | `with-logging` | ~39MB | Fat JAR + Logback (for IntelliJ) |
| `tbc-bq-jdbc-3.0.7-sources.jar` | `sources` | ~200KB | Source code |
| `tbc-bq-jdbc-3.0.7-javadoc.jar` | `javadoc` | ~500KB | Javadoc |
...
dependencies {
    ...
    // Or shaded variant
    implementation 'vc.tbc:tbc-bq-jdbc:3.0.7:shaded'
}
```
...
wget https://repo1.maven.org/maven2/vc/tbc/tbc-bq-jdbc/3.0.7/tbc-bq-jdbc-3.0.7.jar
```
