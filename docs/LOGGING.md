...
### 1. Standard JAR (`tbc-bq-jdbc-3.2.1.jar`)
...
### 2. Shaded JAR (`tbc-bq-jdbc-3.2.1-shaded.jar`)
...
### 3. Shaded JAR with Logging (`tbc-bq-jdbc-3.2.1-with-logging.jar`)
...
1. **Add the driver** to IntelliJ's database configuration:
   ...
   - Select the `tbc-bq-jdbc-3.2.1-with-logging.jar` file
