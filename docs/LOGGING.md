...
### 1. Standard JAR (`tbc-bq-jdbc-2.0.0.jar`)
...
### 2. Shaded JAR (`tbc-bq-jdbc-2.0.0-shaded.jar`)
...
### 3. Shaded JAR with Logging (`tbc-bq-jdbc-2.0.0-with-logging.jar`)
...
1. **Add the driver** to IntelliJ's database configuration:
   ...
   - Select the `tbc-bq-jdbc-2.0.0-with-logging.jar` file
