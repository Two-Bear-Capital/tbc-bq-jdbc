...
tbc-bq-jdbc-4.0.0-with-logging.jar
```
...
6. Set **Class**: `vc.tbc.bq.jdbc.BQDriver`
7. Click **OK**
...
cd tbc-bq-jdbc
./mvnw clean package
# Use target/tbc-bq-jdbc-4.0.0-with-logging.jar
...
2. Check driver class: `vc.tbc.bq.jdbc.BQDriver`
