...
- `tbc-bq-jdbc-1.0.118.jar` - Slim JAR (60K, requires dependencies)
- `tbc-bq-jdbc-1.0.118-shaded.jar` - Shaded JAR with all dependencies (38M)
- `tbc-bq-jdbc-1.0.118-with-logging.jar` - Shaded JAR + Logback for IntelliJ (39M)
- `tbc-bq-jdbc-1.0.118-sources.jar` - Source JAR
- `tbc-bq-jdbc-1.0.118-javadoc.jar` - Javadoc JAR
