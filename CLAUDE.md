...
- `tbc-bq-jdbc-1.0.92.jar` - Slim JAR (60K, requires dependencies)
- `tbc-bq-jdbc-1.0.92.jar` - Shaded JAR with all dependencies (38M)
- `tbc-bq-jdbc-1.0.92-with-logging.jar` - Shaded JAR + Logback for IntelliJ (39M)
- `tbc-bq-jdbc-1.0.92.jar` - Source JAR
- `tbc-bq-jdbc-1.0.92.jar` - Javadoc JAR
