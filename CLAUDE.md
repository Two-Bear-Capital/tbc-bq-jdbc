...
- `tbc-bq-jdbc-1.0.67.jar` - Slim JAR (60K, requires dependencies)
- `tbc-bq-jdbc-1.0.67.jar` - Shaded JAR with all dependencies (38M)
- `tbc-bq-jdbc-1.0.67-with-logging.jar` - Shaded JAR + Logback for IntelliJ (39M)
- `tbc-bq-jdbc-1.0.67.jar` - Source JAR
- `tbc-bq-jdbc-1.0.67.jar` - Javadoc JAR
