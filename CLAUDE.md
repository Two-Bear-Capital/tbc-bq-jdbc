...
- `tbc-bq-jdbc-1.0.45.jar` - Slim JAR (60K, requires dependencies)
- `tbc-bq-jdbc-1.0.45.jar` - Shaded JAR with all dependencies (38M)
- `tbc-bq-jdbc-1.0.45-with-logging.jar` - Shaded JAR + Logback for IntelliJ (39M)
- `tbc-bq-jdbc-1.0.45.jar` - Source JAR
- `tbc-bq-jdbc-1.0.45.jar` - Javadoc JAR
