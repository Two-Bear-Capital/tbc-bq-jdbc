...
- `tbc-bq-jdbc-1.0.129.jar` - Slim JAR (180K, requires dependencies)
- `tbc-bq-jdbc-1.0.129-shaded.jar` - Shaded JAR with all dependencies (36M)
- `tbc-bq-jdbc-1.0.129-with-logging.jar` - Shaded JAR + Logback for IntelliJ (37M)
- `tbc-bq-jdbc-1.0.129-sources.jar` - Source JAR
- `tbc-bq-jdbc-1.0.129-javadoc.jar` - Javadoc JAR
