...
- `tbc-bq-jdbc-1.0.28.jar` - Slim JAR (60K, requires dependencies)
- `tbc-bq-jdbc-1.0.28.jar` - Shaded JAR with all dependencies (51M)
- `tbc-bq-jdbc-1.0.28-with-logging.jar` - Shaded JAR + Logback for IntelliJ (52M)
- `tbc-bq-jdbc-1.0.28.jar` - Source JAR
- `tbc-bq-jdbc-1.0.28.jar` - Javadoc JAR
