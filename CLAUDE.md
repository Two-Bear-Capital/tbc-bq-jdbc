...
- `tbc-bq-jdbc-1.0.9.jar` - Slim JAR (60K, requires dependencies)
- `tbc-bq-jdbc-1.0.9-shaded.jar` - Shaded JAR with all dependencies (51M)
- `tbc-bq-jdbc-1.0.9-with-logging.jar` - Shaded JAR + Logback for IntelliJ (52M)
- `tbc-bq-jdbc-1.0.9-sources.jar` - Source JAR
- `tbc-bq-jdbc-1.0.9-javadoc.jar` - Javadoc JAR
