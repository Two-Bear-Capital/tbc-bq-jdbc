...
- `tbc-bq-jdbc-1.0.32.jar` - Slim JAR (60K, requires dependencies)
- `tbc-bq-jdbc-1.0.32.jar` - Shaded JAR with all dependencies (51M)
- `tbc-bq-jdbc-1.0.32-with-logging.jar` - Shaded JAR + Logback for IntelliJ (52M)
- `tbc-bq-jdbc-1.0.32.jar` - Source JAR
- `tbc-bq-jdbc-1.0.32.jar` - Javadoc JAR
