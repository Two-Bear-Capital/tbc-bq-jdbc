...
- `tbc-bq-jdbc-1.0.36.jar` - Shaded JAR with all dependencies (51M)
- `tbc-bq-jdbc-1.0.36-with-logging.jar` - Shaded JAR + Logback for IntelliJ (52M)
- `tbc-bq-jdbc-1.0.36.jar` - Source JAR
- `tbc-bq-jdbc-1.0.36.jar` - Javadoc JAR
