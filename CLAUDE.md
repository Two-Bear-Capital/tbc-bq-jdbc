...
- `tbc-bq-jdbc-2.1.1.jar` - Slim JAR (180K, requires dependencies)
- `tbc-bq-jdbc-2.1.1-shaded.jar` - Shaded JAR with all dependencies (36M)
- `tbc-bq-jdbc-2.1.1-with-logging.jar` - Shaded JAR + Logback for IntelliJ (37M)
- `tbc-bq-jdbc-2.1.1-sources.jar` - Source JAR
- `tbc-bq-jdbc-2.1.1-javadoc.jar` - Javadoc JAR
