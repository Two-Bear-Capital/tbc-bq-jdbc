...
- `tbc-bq-jdbc-1.0.103.jar` - Slim JAR (60K, requires dependencies)
- `tbc-bq-jdbc-1.0.103-shaded.jar` - Shaded JAR with all dependencies (38M)
- `tbc-bq-jdbc-1.0.103-with-logging.jar` - Shaded JAR + Logback for IntelliJ (39M)
- `tbc-bq-jdbc-1.0.103-sources.jar` - Source JAR
- `tbc-bq-jdbc-1.0.103-javadoc.jar` - Javadoc JAR
